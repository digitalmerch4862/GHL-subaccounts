...
const testimonials = [
  {
    ...
    content: "Bro, Gemini DeepResearch literally saved my thesis. I finished my RRL in 2 days instead of 2 weeks. Plus ad-free study music on YT Premium? Sobrang sulit for ₱999.",
    rating: 5,
  ...
  },
  {
    ...
    content: "I was paying ₱479/mo just for Google One storage. Now I have 2TB for life. The transfer was smooth, and my files are private. Best investment for my career.",
    rating: 5,
  ...
  },
  {
    ...
    content: "Jules Coding Agent is legit. It debugs my React code faster than I can read the error logs. Feels like cheating but I'm not complaining. 10/10 recommend.",
    rating: 5,
    ...
    <section className="py-20 bg-cyber-black relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400">Join 5,000+ Filipinos upgrading their digital life.</p>
        </div>
