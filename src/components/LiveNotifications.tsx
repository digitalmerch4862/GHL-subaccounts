    ...
    <>
      ...
      <AnimatePresence>
        {notification && (
          ...
          >
            <div className="bg-cyber-gray/90 backdrop-blur-md border border-neon-green/50 p-4 rounded-lg shadow-lg shadow-neon-green/10 flex items-start gap-3">
